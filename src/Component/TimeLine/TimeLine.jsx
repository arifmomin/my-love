    ...
    <div id='TimeLine' className='w-full h-full py-16 md:py-24 mb-28'>
      ...
      <div className="w-[250px] relative">
        ...
        <div className="absolute top-1/2 left-1/2 w-full h-full flex flex-col justify-center items-center counter">
          <h3 className="text-sm sm:text-base md:text-[56px] text-fontColor font-semibold font-caps">{timeElapsed.days}</h3>
      ...
      <div className="w-[250px] relative">
        <img src={fram} alt="timeline.png" />
        <div className="absolute top-1/2 left-1/2 w-full h-full flex flex-col justify-center items-center counter">
          <h3 className="text-sm sm:text-base md:text-[56px] text-fontColor font-semibold font-caps">{timeElapsed.hours}</h3>
      ...
      <div className="w-[250px] relative">
        <img src={fram} alt="timeline.png" />
        <div className="absolute top-1/2 left-1/2 w-full h-full flex flex-col justify-center items-center counter">
          <h3 className="text-sm sm:text-base md:text-[56px] text-fontColor font-semibold font-caps">{timeElapsed.minutes}</h3>
      ...
      <div className="w-[250px] relative">
        <img src={fram} alt="timeline.png" />
        <div className="absolute top-1/2 left-1/2 w-full h-full flex flex-col justify-center items-center counter">
          <h3 className="text-sm sm:text-base md:text-[56px] text-fontColor font-semibold font-caps">{timeElapsed.seconds}</h3>
