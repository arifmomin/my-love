            ...
            <div className='max-w-[1250px] m-auto mt-10'>
                <div className='flex flex-col md:flex-row'>
                    <div className='w-full md:w-1/2'>
                        <img className='story-image' src={FirstMet} alt="first-met.svg" />
                    </div>
                    <div className='md:p-[30px] flex-1'>
                        <div className='flex flex-col justify-center w-full h-full'>
                        <h2 className='story-title'>First time we met</h2>
                        <h3 className='text-sm sm:text-base md:text-xl text-black font-medium font-caps md:mt-2 mb-2 md:mb-3'>November 29 2024</h3>
                ...
                <div className='flex flex-col-reverse md:flex-row'>
                    <div className='md:p-[30px] flex-1'> 
                        ...
                        <h3 className='text-sm sm:text-base md:text-xl text-black font-medium font-caps md:mt-2 mb-2 md:mb-3'>December 12 2024</h3>
                    ...
                    <div className='w-full md:w-1/2'>
                        <img className='story-image' src={FirstDate} alt="first-date.svg" />
                    </div>
                </div>
                <div className='flex flex-col md:flex-row'>
                    <div className='w-full md:w-1/2'>
                        <img className='story-image' src={Engegment} alt="engagement.svg" />
                    </div>
                    <div className='md:p-[30px] flex-1'>
                        <div className='flex flex-col justify-center w-full h-full'>
                        <h2 className='story-title'>A Promise of Forever</h2>
                        <h3 className='text-sm sm:text-base md:text-xl text-black font-medium font-caps md:mt-2 mb-2 md:mb-3'>Month Day Year</h3>
                        <p className='text-sm sm:text-base md:text-[18px] text-gray-500 font-normal font-roboto mb-5 md:mb-0'>
                ...
                <div className='flex flex-col-reverse md:flex-row'>
                    <div className='md:p-[30px] flex-1'>
                        ...
                        <h3 className='text-sm sm:text-base md:text-xl text-black font-medium font-caps md:mt-2 mb-2 md:mb-3'>Dec 12 2024</h3>
                        <p className='text-sm sm:text-base md:text-[18px] text-gray-500 font-normal font-roboto text-start md:text-end mb-5 md:mb-0'>
