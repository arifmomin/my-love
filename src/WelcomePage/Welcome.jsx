...
const Welcome = () => {
  ...
  return (
    <>
      <div className='container w-full h-screen flex flex-col justify-center items-center bg-BrandColor'>
        ...
        <div className='flex justify-center items-center sm:gap-x-[50px] gap-x-[15px]'>
          <div className='welcome-LeftName relative flex flex-col justify-center items-center gap-y-[30px]'>
            <div className='welcome-image w-[130px] h-[130px] sm:w-[350px] sm:h-[350px]'>
              <img className='w-full h-full' src={leftImage} alt={leftImage} />
            </div>
            <div className='input-left relative h-[30px] border border-fontColor rounded-md sm:border-none sm:rounded-none sm:h-[60px] w-full max-w-[130px] sm:max-w-[350px] flex z-50'>
              <input
                className={`w-full sm:w-[280px] h-full pl-[10px] sm:pl-[35px] bg-transparent text-sm sm:text-[18px] font-medium font-robot
              ...
              <div className='hidden sm:flex justify-center items-center flex-1 duration-300 ease-linear'>
                <span className='text-xl text-fontColor font-medium font-roboto'>
                  AK
                </span>
              </div>
            </div>
          ...
          <div className='welcome-image w-[130px] h-[130px] sm:w-[350px] sm:h-[350px]'>
            ...
            <div className='input-left relative h-[30px] border border-fontColor rounded-md sm:border-none sm:rounded-none sm:h-[60px] w-full max-w-[130px] sm:max-w-[350px] flex z-50'>
              ...
              <a
                href='#'
                className='hidden sm:flex justify-center items-center flex-1 text-2xl text-fontColor duration-300 ease-linear'
